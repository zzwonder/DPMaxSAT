...
const string MAXSAT_OPTION = "mx";
const string MAXSAT_BOUND_OPTION = "mb";
...
public:
  ...
  static Dd getClauseSDd(const Map<Int, Int>& cnfVarToDdVarMap, const Clause& clause, const Cudd* mgr, const Assignment& assignment);
  static Dd getXORDd(
    const Map<Int, Int>& cnfVarToDdVarMap,
    const Clause& clause,
    const Cudd* mgr,
  ...
  static void printMaximizer(stack<pair<int, Dd> >& stackMaximizer , const vector<Int>& ddVarToCnfVarMap, const Cudd* mgr = nullptr);
